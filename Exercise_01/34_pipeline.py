...
Original file is located at
    https://colab.research.google.com/drive/1wEn_kP11NxXR3KX58rBsmtzHqACAeDVH
"""
...
def pipeline_model(path):
    ...
    # face recognition
    face_recognition_model = pickle.load(open(path + 'ml_face_person_identity.pkl',
                                            mode='rb'))
    # pipeline model
    img = cv2.imread(path)
    image = img.copy()
...
img, results = pipeline_model(path + 'FaceImage/1721031512_LeMinhNghia/image_1220.jpg')
cv2.imshow(img)

img, results = pipeline_model(path + 'FaceImage/1721030881_ThanTrongPhuc/image_1080.jpg')
cv2.imshow(img)

img, results = pipeline_model(path + 'FaceImage/172100358_DoanVuBinhDuong/dataimage_1000.jpg')
cv2.imshow(img)